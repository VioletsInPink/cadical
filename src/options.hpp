...
OPTION( lratpalrup,        0,  0,  1,0,0,1, "output in PalRUP parallel proof format") \
...
OPTION( vivifyonlycount,   1,  1,2e9,0,0,1, "number of solvers of this type in the computation") \
